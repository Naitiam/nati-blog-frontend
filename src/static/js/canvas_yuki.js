...
function init() {
    ...
    for (let i = 0; i < 100; i++) {
        ...
        let x = randomIntFromRange(radius, cwidth - radius);
        let y = randomIntFromRange(radius, cheight - radius);
        let dx = 0;
...
function animate() {
 ...
 function canva(ctx1, w1, h1) {
     ctx = ctx1;
     cheight = h1;
     cwidth = w1;
 }

export {init,animate,canva };